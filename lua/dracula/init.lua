...
M.apply = function()
  ...
  highlight("TSTag", colors.cyan, nil, nil, nil)
	...
	highlight('DiagnosticInfo', colors.green, nil, nil, nil)
	...
	highlight('DiagnosticUnderlineInfo', nil, nil, 'undercurl', colors.green)
	...
	highlight('DiagnosticSignInfo', colors.green, nil, nil, nil)
	...
	highlight('DiagnosticFloatingInfo', colors.green, nil, nil, nil)
	...
	highlight('DiagnosticVirtualTextInfo', colors.green, nil, nil, nil)
	...
	highlight('LspDiagnosticsUnderlineInformation', colors.green, nil, 'undercurl', nil)
